...
class FloatingLabelSearchField extends StatefulWidget {
  // The placeholder text that will float and become the label.
...
class _FloatingLabelSearchFieldState extends State<FloatingLabelSearchField>
  ...
  // An animation for the position and font size of the label.
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = _focusNode.hasFocus ? Colors.blue : Colors.grey[400];

    return GestureDetector(
      // The GestureDetector makes the entire area tappable.
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final topOffset =
              _animation.value * (-_labelFontSize - _containerVerticalPadding);
          final leftOffset =
              _animation.value *
              _labelHorizontalPadding *
              0; // The label doesn't move horizontally.
          final fontSize =
              _labelFontSize -
          ...
          return Container(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  top: _containerVerticalPadding + topOffset,
